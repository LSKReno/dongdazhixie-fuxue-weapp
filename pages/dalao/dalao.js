...
Page({
    ...
    //dalao登录
    dalaoSignin: function() {
        // console.log(this.data.multiIndex[0] + "," + this.data.multiIndex[1])
        try {
            wx.setStorageSync('personType', 0)
            ...
            console.log("大佬personType本地出错啦")
        }

        wx.request({
            url: this.data.mainUrl+'/dalao', // 接口地址
            data: {
